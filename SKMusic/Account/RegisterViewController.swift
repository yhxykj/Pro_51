...
final class RegisterViewController: UIViewController, UITextFieldDelegate {
    ...
    private func setupViews() {
        ...
        formContentView.addSubview(signUpTitleImageView)
        ...
        formContentView.addSubview(existingAccountButton)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            existingAccountButton.centerXAnchor.constraint(equalTo: formContentView.centerXAnchor),
            ...
            continueButton.topAnchor.constraint(equalTo: existingAccountButton.bottomAnchor, constant: 52),
